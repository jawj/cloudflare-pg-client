...
if [ "$1" != "quick" ]; then
  echo "Compiling WolfSSL to WASM ..."
    emcc -c -I../wolfssl-5.5.1-stable/ src/wolfssl.c -o build/tls.o -Oz # -DCHATTY -DUSESUBTLECB

    emcc build/tls.o \
      ../wolfssl-5.5.1-stable/wolfcrypt/src/*.o ../wolfssl-5.5.1-stable/src/*.o \
      -o build/tls.js \
      -sEXPORTED_FUNCTIONS=_initTls,_writeData,_readData,_pending,_malloc,_free \
